...
public class MutePunishment implements Punishment {
	...
	private MutePunishment(PunishProfile punishProfile, UUID punishId, UUID punisher, String reason,
	...
	public static MutePunishment create(PunishProfile punishProfile, UUID punishId, UUID punisher,
	                                    String reason, long date, boolean invalid) {
		return new MutePunishment(punishProfile, punishId, punisher, reason, date, invalid);
	}
	...
	public void checkIfExpired() {
		if (!isActive() && !expired) {
			...
			punishProfile.setActiveMute(null);
			punishProfile.getExpiredMutes().add(this);
